...
export class Migrations1685445879376 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "application" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "application_name" character varying NOT NULL, "icon" character varying NOT NULL, "description" character varying(500) NOT NULL, "organization" character varying NOT NULL DEFAULT 'ITEX', "latest_version" character varying NOT NULL, "device" character varying NOT NULL, "program_file_name" character varying NOT NULL, "program_file_version" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'ACTIVE', "shareToSubOrganization" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_569e0c3e863ebdf5f2408ee1670" UNIQUE ("id"), CONSTRAINT "UQ_35a70088180db2d7b27dd5c5b57" UNIQUE ("application_name"), CONSTRAINT "PK_569e0c3e863ebdf5f2408ee1670" PRIMARY KEY ("id"))`);
